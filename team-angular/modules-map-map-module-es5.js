(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-map-map-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppModulesMapMapComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "<div #googlemaps id=\"googlemaps\"></div>";
    /***/
  },
  ...
  /***/
  function srcAppModulesMapMapRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    MapRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      providers: []
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])], MapRoutingModule);
    /***/
  },
  ...
  /***/
  function srcAppModulesMapMapComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppModulesMapMapComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    let MapComponent = class MapComponent {
      ...
      initMap() {
        if (navigator.geolocation) {
          navigator.geolocation.getCurrentPosition(position => {
            this.geoLocation = new google.maps.LatLng(position.coords.latitude, position.coords.longitude), this.map = new google.maps.Map(this.mapElement.nativeElement, MapOpts);
          ...
          this.watchPositionId = navigator.geolocation.watchPosition(position => {
            this.geoLocation = new google.maps.LatLng(position.coords.latitude, position.coords.longitude), this.map.panTo(this.geoLocation);
            this.marker.setPosition(this.geoLocation);
      ...
      updateDashboard(position) {
        ...
        this.geoAltitude = parseInt(Math.round(position.coords.altitude).toFixed(0), 10); // document.getElementById("geoSpeed").innerText = this.geoSpeed + "";
      ...
      displayDeviceOrientation(event) {
        ...
        this.deviceDirection = parseInt(Math.round(event.gamma).toFixed(0), 10); // document.getElementById("deviceDirection").innerText = this.deviceDirection + "";
        // document.getElementById("deviceHeading").innerText = this.deviceHeading + "";
      }

    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])("googlemaps", {
      static: false
    ...
    MapComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/map/map.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./map.component.css */
      "./src/app/modules/map/map.component.css")).default]
  ...
  /***/
  function srcAppModulesMapMapModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])], MapModule);
    /***/
  }
}]);
//# sourceMappingURL=modules-map-map-module-es5.js.map